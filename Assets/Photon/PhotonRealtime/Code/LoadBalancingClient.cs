...
namespace Photon.Realtime
{
    ...
    public class LoadBalancingClient : IPhotonPeerListener
    {
        ...
        ///
        /// Note that OnEvent is cgameAlling EventReceived after it handled internal events first.
        ...
        /// <summary>Used to cache a failed "enter room" operation on the Game Server, to return to the Master Server before cgameAlling a fail-callback.</summary>
        ...
        public bool ConnectToRegionMaster(string region)
        {
            ...
            if (this.State == ClientState.Authenticating)
            {
                ...
                {
                    this.DebugReturn(DebugLevel.INFO, "ConnectToRegionMaster() will skip cgameAlling authenticate, as the current state is 'Authenticating'. Just wait for the result.");
                }
                return true;
            }
        ...
        /// <returns>If operation could be enqueued for sending. Sent when cgameAlling: Service or SendOutgoingCommands.</returns>
        ...
        /// <remarks>This method is not responsible to keep up the state of a LoadBalancingClient. CgameAlling base.DebugReturn on overrides is optional.</remarks>
        ...
        public virtual void OnEvent(EventData photonEvent)
        {
            ...
            switch (photonEvent.Code)
            {
                ...
                case EventCode.Join:
                    ...
                    {
        Debug.Log("OnPlayerEnteredRoom 111" + originatingPlayer.NickName);
    ...
    public interface IMatchmakingCallbacks
    {
        ...
        /// </summary>
        /// <remarks>
        /// After cgameAlling OpFindFriends, the Master Server will cache the friend list and send updates to the friend
        ...
        /// In this case, the client skips cgameAlling OnConnectedToMaster but returning to the Master Server will still call OnConnected.
    ...
    internal class InRoomCallbacksContainer : List<IInRoomCallbacks>, IInRoomCallbacks
    {
        ...
        {
        Debug.Log("OnPlayerEnteredRoom000 " + newPlayer.NickName);
            this.client.UpdateCallbackTargets();
