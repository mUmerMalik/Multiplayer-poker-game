...
namespace Photon.Pun
{
    ...
    public class PhotonView : MonoBehaviour
    {
        ...
        /// <summary>
        /// This is the InstantiationData that was passed when cgameAlling PhotonNetwork.Instantiate* (if that was used to spawn this prefab)
        /// </summary>
        ...
        /// ownership by cgameAlling the PhotonView's RequestOwnership method.
        /// The current owner has to implement IPunCallbacks.OnOwnershipRequest to react to the ownership request.
        /// </remarks>
