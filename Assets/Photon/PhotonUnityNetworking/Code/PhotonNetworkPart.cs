...
namespace Photon.Pun
{
    ...
    public static partial class PhotonNetwork
    {
        ...
        internal static void LocalCleanupAnythingInstantiated(bool destroyInstantiatedGameObjects)
        {
            ...
            //{
            //    Debug.LogWarning("It seems some instantiation is not completed, as instantiation data is used. You should make sure instantiations are paused when cgameAlling this method. Cleaning now, despite ");
            //}
