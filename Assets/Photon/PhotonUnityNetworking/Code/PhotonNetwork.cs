...
namespace Photon.Pun
{
    ...
    public static partial class PhotonNetwork
    {
        ...
        /// This means you can set the GameVersion right after cgameAlling ConnectUsingSettings (e.g.) and the new value will be used on the server.
        ...
        /// </summary>
        /// <remarks>
        /// Set these before cgameAlling Connect if you want custom authentication.
        ...
        ///
        /// CgameAlling RPCs will not trigger a send.
        ///
        ...
        ///
        /// Info:
        /// PUN is running a "fallback thread" to send ACKs to the server, even when Unity is not cgameAlling Update() regularly.
        ...
        ///
        /// To ignore the settings file, set the relevant values and connect by cgameAlling
        ...
        /// </summary>
        /// <remarks>
        /// Will save the result of pinging all cloud servers in PlayerPrefs. CgameAlling this the first time can take +-2 seconds.
        ...
        ///
        /// CgameAlling LoadLevel before the previous scene finished loading is not recommended.
