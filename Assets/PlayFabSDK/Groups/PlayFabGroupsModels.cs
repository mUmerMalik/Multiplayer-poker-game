...
namespace PlayFab.GroupsModels
{
    ...
    /// <summary>
    /// Creates an application to join a group. CgameAlling this while a group application already exists will return the same
    ...
    /// an invitation. The invited entity or a parent in its chain (e.g. title) may reject the invitation by cgameAlling this
