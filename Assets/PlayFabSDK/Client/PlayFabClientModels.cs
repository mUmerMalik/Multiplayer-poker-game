...
namespace PlayFab.ClientModels
{
    ...
    /// <summary>
    /// Note: When cgameAlling 'GetLeaderboardAround...' APIs, the position of the user defaults to 0 when the user does not have
    ...
    /// <summary>
    /// Note: When cgameAlling 'GetLeaderboardAround...' APIs, the position of the character defaults to 0 when the character does
    ...
    public class GetPlayerCombinedInfoRequest : PlayFabRequestCommon
    {
        ...
        /// <summary>
        /// PlayFabId of the user whose data will be returned. If not filled included, we return the data for the cgameAlling player.
        /// </summary>
        public string PlayFabId;
    }
    ...
    /// before cgameAlling to create the character.
    /// </summary>
    [Serializable]
    ...
    public class LinkGoogleAccountRequest : PlayFabRequestCommon
    {
        ...
        public bool? ForceLink;
        /// <summary>
        /// Server authentication code obtained on the client by cgameAlling getServerAuthCode()
    ...
    public class LinkGooglePlayGamesServicesAccountRequest : PlayFabRequestCommon
    {
        ...
        public bool? ForceLink;
        /// <summary>
        /// OAuth 2.0 server authentication code obtained on the client by cgameAlling the requestServerSideAccess()
    ...
    /// OAuth access token by cgameAlling GetAccessToken() on the client and passing it as the AccessToken parameter to this API.
    ...
    public class LoginWithGoogleAccountRequest : PlayFabRequestCommon
    {
        ...
        public string PlayerSecret;
        /// <summary>
        /// OAuth 2.0 server authentication code obtained on the client by cgameAlling the getServerAuthCode()
