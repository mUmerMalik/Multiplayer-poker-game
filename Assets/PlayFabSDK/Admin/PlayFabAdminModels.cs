...
namespace PlayFab.AdminModels
{
    ...
    {
        /// <summary>
        /// The player shared secret to use when cgameAlling Client/GetTitlePublicKey
        /// </summary>
    ...
    /// cgameAlling GetPlayedTitleList, before cgameAlling this API.
    /// </summary>
    [Serializable]
    ...
    /// <summary>
    /// Note that when cgameAlling this API, all properties of the task have to be provided, including properties that you do not
